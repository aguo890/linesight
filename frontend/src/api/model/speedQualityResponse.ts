 ...
 */
import type { SpeedQualityPoint } from './speedQualityPoint';

/**
 * Speed vs Quality trade-off analysis.
 */
export interface SpeedQualityResponse {
  /** Daily trend of efficiency vs defects */
  data_points: SpeedQualityPoint[];
}
