...
import { Factory as FactoryIcon, Users, Layers, ChevronRight, ArrowLeft } from 'lucide-react';
        ...
        <div>
            ...
            <div className="mb-8">
                ...
                <p className="text-[var(--color-text-muted)] mt-1">
                    Select a factory to manage team access for its production lines.
                </p>
            </div>
            ...
            {factories.length === 0 ? (
                <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] p-12 text-center">
                    <FactoryIcon className="w-12 h-12 text-[var(--color-text-subtle)] mx-auto mb-4" />
                    <h3 className="text-lg font-semibold text-[var(--color-text)] mb-2">No Factories Yet</h3>
                    <p className="text-[var(--color-text-muted)] mb-4">
                        Create a factory first to start assigning managers to production lines.
                    </p>
                    <button
