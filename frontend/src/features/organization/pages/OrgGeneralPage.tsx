...
const OrgGeneralPage: React.FC = () => {
    ...
    return (
        <div className="w-full">
            ...
            <SettingsPageHeader title={t('org_general.title')} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--color-text-muted)]">
                            {t('org_general.profile.logged_in_as')} <span className="font-medium">{user?.email}</span>
                        </p>
            ...
            <div className="border border-red-200 dark:border-red-900/30 rounded-xl p-6 bg-red-50/50 dark:bg-red-900/10">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-red-700 dark:text-red-200">{t('org_general.danger_zone.title')}</h3>
                </div>
                <p className="text-sm text-red-600 dark:text-red-300 mb-4">
                    {t('org_general.danger_zone.description')}
                </p>
                <button
                    disabled
                ...
                >
                    {t('org_general.danger_zone.delete_button')}
                </button>
            </div>
        </div>
    );
