...
def upgrade() -> None:
    ...
    sa.Column('parent_data_source_id', mysql.CHAR(length=36), nullable=True),
    sa.Column('is_segment', sa.Boolean(), nullable=False),
    ...
    op.create_index(op.f('ix_data_sources_production_line_id'), 'data_sources', ['production_line_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['production_line_id'], ['data_sources.id'], ondelete='SET NULL'),
    ...
    sa.Column('user_id', mysql.CHAR(length=36), nullable=False),
    sa.Column('scope_type', sa.Enum('organization', 'factory', 'data_source', 'line', name='rolescope'), nullable=False),
    sa.Column('organization_id', mysql.CHAR(length=36), nullable=True),
    sa.Column('factory_id', mysql.CHAR(length=36), nullable=True),
    sa.Column('data_source_id', mysql.CHAR(length=36), nullable=True),
    sa.Column('role', sa.Enum('system_admin', 'owner', 'factory_manager', 'line_manager', 'analyst', 'viewer', name='userrole'), nullable=False),
    ...
    op.create_index(op.f('ix_production_runs_data_source_id'), 'production_runs', ['data_source_id'], unique=False)
    ...
    op.create_index(op.f('ix_production_events_data_source_id'), 'production_events', ['data_source_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_production_events_data_source_id'), table_name='production_events')
    ...
    op.drop_index(op.f('ix_production_runs_data_source_id'), table_name='production_runs')
    ...
    op.drop_index(op.f('ix_data_sources_factory_id'), table_name='data_sources')
